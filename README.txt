...
app is functionally complete (i think). still, improvements can be made in places:
- more modularization of subviews can be done

- be sure on whether a variable should be @state, @binding, and normal. (i think theres just one place where im unsure)
